...
st.sidebar.image(
    "https://i.pinimg.com/originals/27/07/eb/2707ebe3f9114547b13a6ad01daf5f51.png")
...
if user_menu == "Country-Wise Analysis":
    ...
    st.title(selected_country + " Performance Heatmap over the years")
    pt = helper.country_event_heatmap(df, selected_country)
    fig, ax = plt.subplots(figsize=(20, 20))
    ax = sns.heatmap(pt, annot=True)
    st.pyplot(fig)

    st.title(selected_country + "'s most successful athletes.")
    topCountry_df = helper.most_successful_country(df, selected_country)
    st.table(topCountry_df.reset_index())
...
if user_menu == "Athlete-Wise Analysis":
    ...
    fig = ff.create_distplot([x1, x2, x3, x4], ["Age Distribution", "Gold Medalist",
